...
export default function User({ location, history }) {
  ...
  useEffect(() => {
    async function loadClient() {
      const response = await api.get(`/users/${location.state.key}`);
      setClient(response.data[0]);
      response.data[0].addresses.length === 2 ? setMenu(true) : setMenu(false);
    }
    loadClient();
  }, [location.state.key]);
      ...
      <div className="content-add">
        ...
        <Formik
          ...
          initialValues={{
            ...
            addresses: [
              {
                id: client.email ? client.addresses[0].id : '',
                cep: client.email ? client.addresses[0].cep : '',
                state: client.email ? client.addresses[0].state : '',
                city: client.email ? client.addresses[0].city : '',
                neighborhood: client.email
                  ? client.addresses[0].neighborhood
                  : '',
                address: client.email ? client.addresses[0].address : '',
                number: client.email ? client.addresses[0].number : '',
                complement: client.email ? client.addresses[0].complement : '',
                type: client.email ? client.addresses[0].type : '',
                main: true
              },
              {
                id: client.email
                  ? client.addresses.length === 2
                    ? client.addresses[1].id
                    : ''
                  : '',
                cep: client.email
                  ? client.addresses.length === 2
                    ? client.addresses[1].cep
                    : ''
                  : '',
                state: client.email
                  ? client.addresses.length === 2
                    ? client.addresses[1].state
                    : ''
                  : '',
                city: client.email
                  ? client.addresses.length === 2
                    ? client.addresses[1].city
                    : ''
                  : '',
                neighborhood: client.email
                  ? client.addresses.length === 2
                    ? client.addresses[1].neighborhood
                    : ''
                  : '',
                address: client.email
                  ? client.addresses.length === 2
                    ? client.addresses[1].address
                    : ''
                  : '',
                number: client.email
                  ? client.addresses.length === 2
                    ? client.addresses[1].number
                    : ''
                  : '',
                complement: client.email
                  ? client.addresses.length === 2
                    ? client.addresses[1].complement
                    : ''
                  : '',
                type: client.email
                  ? client.addresses.length === 2
                    ? client.addresses[1].type
                    : 0
                  : 0
              }
            ]
